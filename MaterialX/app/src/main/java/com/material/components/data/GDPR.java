...
public class GDPR {
    ...
    public static void updateConsentStatus(final Activity act) {
        ...
        consentInformation.requestConsentInfoUpdate(new String[]{remoteConfig.getPublisherId()}, new ConsentInfoUpdateListener() {
            @Override
    ...
    private static class GDPRForm {
        ...
        private URL getUrlPrivacyPolicy(Activity act) {
            URL mUrl = null;
            try {
                mUrl = new URL(remoteConfig.getPrivacyPolicyUrl());
